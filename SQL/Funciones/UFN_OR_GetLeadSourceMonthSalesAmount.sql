if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[UFN_OR_GetLeadSourceMonthSalesAmount]') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].[UFN_OR_GetLeadSourceMonthSalesAmount]
GO
...
** 
** [caduran]	23/Sep/2013 Created. Se agrego la agrupacion por Lead Source, se baso en el procedimiento 'UFN_OR_Get MonthSalesAmount'
** [wtorres]	04/Jun/2015 Modified. Agregue el parametro @External
**
*/
create function [dbo].[UFN_OR_GetLeadSourceMonthSalesAmount](
