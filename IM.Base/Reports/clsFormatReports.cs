...
namespace IM.Base.Reports
{
  public static class clsFormatReports
  {
    ...
    public static ColumnFormatList RptManifestRangeByLs(EnumModule module)
    {
      ...
      lst.Add("WO", "WO", EnumFormatTypeExcel.Boolean, function: DataFieldFunctions.Count, width: 6);
      lst.Add("CT", "CTour", EnumFormatTypeExcel.Boolean, function: DataFieldFunctions.Count, width: 4);
      lst.Add("Sv", "STour", EnumFormatTypeExcel.Boolean, function: DataFieldFunctions.Count, width: 12);
      lst.Add("D", "Direct", EnumFormatTypeExcel.Boolean, function: DataFieldFunctions.Count, width: 6);
      lst.Add("R", "Resch", EnumFormatTypeExcel.Boolean, function: DataFieldFunctions.Count, width: 6);
      lst.Add("N°", "PR1", width: 8);
      lst.Add("PR/SG", "PR1N", fontSize: 6, wordWrap: true);
      lst.Add("N°", "Liner1", width: 5);
      lst.Add("Sales R.", "Liner1N", fontSize: 6, wordWrap: true);
      lst.Add("N°", "Closer1", width: 5);
      lst.Add("FM1", "Closer1N", fontSize: 6, wordWrap: true);
      lst.Add("N°", "Closer2", width: 5);
      lst.Add("FM2", "Closer2N", fontSize: 6, wordWrap: true);
      lst.Add("N°", "Exit1", width: 5);
