...
new ExcelFormatTable { Title = "Exchange Rate", PropertyName = "exExchRate", Format = EnumFormatTypeExcel.Currency, Order = 10 },
...
new ExcelFormatTable() { Title = "CxC Gifts", PropertyName = "grCxCGifts", Format = EnumFormatTypeExcel.Currency, Order = 9 },
new ExcelFormatTable() { Title = "CxC Dep", PropertyName = "grCxCPRDeposit", Format = EnumFormatTypeExcel.Currency, Order = 10 },
new ExcelFormatTable() { Title = "CxC Taxi", PropertyName = "grCxCTaxiOut", Format = EnumFormatTypeExcel.Currency, Order = 11 },
new ExcelFormatTable() { Title = "CxC", PropertyName = "CxC", Format = EnumFormatTypeExcel.Currency, Order = 12 }
      };
    }
...
new ExcelFormatTable() { Title = "Comments", PropertyName = "Comments", Axis = ePivotFieldAxis.Row, Order = 28 }
      };
    }
...
new ExcelFormatTable() { Title = "GroupSource2", PropertyName = "GroupSource2", Axis = ePivotFieldAxis.Row, IsGroup= true, Order = 2 }
    ...
    {
      return new List<ExcelFormatTable>() {
new ExcelFormatTable() { Title = "Program", PropertyName = "Program", Axis=ePivotFieldAxis.Row, Order = 1 },
new ExcelFormatTable() { Title = "Receipt", PropertyName = "Receipt", Axis = ePivotFieldAxis.Row, Order = 2 },
new ExcelFormatTable() { Title = "Date", PropertyName = "Date", Format = EnumFormatTypeExcel.Date, Order = 3 },
new ExcelFormatTable() { Title = "Cancel", PropertyName = "Cancel", Axis = ePivotFieldAxis.Row, SubTotalFunctions = eSubTotalFunctions.Count, Order = 4 },
new ExcelFormatTable() { Title = "Cancel Date", PropertyName = "CancelDate", Axis = ePivotFieldAxis.Row, Order = 5 },
new ExcelFormatTable() { Title = "Sales Room", PropertyName = "SalesRoom", Axis = ePivotFieldAxis.Row, Order = 6 },
new ExcelFormatTable() { Title = "Lead Source", PropertyName = "LeadSource", Axis = ePivotFieldAxis.Row, Order = 7 },
new ExcelFormatTable() { Title = "PR ID", PropertyName = "PR", Axis = ePivotFieldAxis.Row, Order = 8 },
new ExcelFormatTable() { Title = "PR Name", PropertyName = "PRN", Axis = ePivotFieldAxis.Row, Order = 9 },
new ExcelFormatTable() { Title = "Out Invit", PropertyName = "OutInvit", Axis = ePivotFieldAxis.Row, Order = 10 },
new ExcelFormatTable() { Title = "GUID", PropertyName = "GuestID", Axis = ePivotFieldAxis.Row, Order = 11 },
new ExcelFormatTable() { Title = "Last Name", PropertyName = "LastName", Axis = ePivotFieldAxis.Row, Order = 12 },
new ExcelFormatTable() { Title = "First Name", PropertyName = "FirstName", Axis = ePivotFieldAxis.Row, Order = 13 },
new ExcelFormatTable() { Title = "Gift ID", PropertyName = "Gift", Axis = ePivotFieldAxis.Row, Order = 14 },
new ExcelFormatTable() { Title = "Gift Name", PropertyName = "GiftN", Axis = ePivotFieldAxis.Row, Order = 15 },
new ExcelFormatTable() { Title = "Gift Sale", PropertyName = "GiftSale", Axis = ePivotFieldAxis.Row, Order = 16 },
new ExcelFormatTable() { Title = "Adults", PropertyName = "Adults", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Number, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 17 },
new ExcelFormatTable() { Title = "Minors", PropertyName = "Minors", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Number, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 18 },
new ExcelFormatTable() { Title = "Extra Adults", PropertyName = "ExtraAdults", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Number, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 19 },
new ExcelFormatTable() { Title = "Price US", PropertyName = "PriceUS", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 20 },
new ExcelFormatTable() { Title = "Price MX", PropertyName = "PriceMX", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 21 },
new ExcelFormatTable() { Title = "Price CAN", PropertyName = "PriceCAN", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 22 },
new ExcelFormatTable() { Title = "Total To Pay", PropertyName = "TotalToPay", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 23 },
new ExcelFormatTable() { Title = "Payment Total", PropertyName = "PaymentTotal", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 24 },
new ExcelFormatTable() { Title = "Difference", PropertyName = "Difference", Axis = ePivotFieldAxis.Row, Format = EnumFormatTypeExcel.Currency, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 25 },
new ExcelFormatTable() { Title = "User ID", PropertyName = "User", Axis = ePivotFieldAxis.Row, Order = 26 },
new ExcelFormatTable() { Title = "User Name", PropertyName = "UserN", Axis = ePivotFieldAxis.Row, Order = 27 },
new ExcelFormatTable() { Title = "Amount", PropertyName = "Amount", Axis = ePivotFieldAxis.Values, Format =EnumFormatTypeExcel.Currency, AggregateFunction = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 28 },
new ExcelFormatTable() { Title = "Exchange Rate", PropertyName = "ExchangeRate", Axis = ePivotFieldAxis.Row, Order = 29 },
...
new ExcelFormatTable() { Title = "Proc Orig",  PropertyName = "ProcOriginal", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 47 },
new ExcelFormatTable() { Title = "Proc New", PropertyName = "ProcNew", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 48 },
new ExcelFormatTable() { Title = "Proc Gross", PropertyName = "ProcGross",  Format = EnumFormatTypeExcel.Currency,Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 49 },
...
new ExcelFormatTable() { Title = "Pend Original", PropertyName = "PendOriginal", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 51 },
new ExcelFormatTable() { Title = "Pend New", PropertyName = "PendNew", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 52 },
new ExcelFormatTable() { Title = "Pend Gross", PropertyName = "PendGross", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 53 },
new ExcelFormatTable() { Title = "C Cost", PropertyName = "ClosingCost", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 54 },
...
new ExcelFormatTable() { Title = "Room", PropertyName = "guRoomNum", Order = 3 },
new ExcelFormatTable() { Title = "Hotel", PropertyName = "guHotel", IsVisible = false },
new ExcelFormatTable() { Title = "Last Name", PropertyName = "guLastName1", Order = 4 },
new ExcelFormatTable() { Title = "First Name", PropertyName = "guFirstName1", Order = 5 },
new ExcelFormatTable() { Title = "Loc", PropertyName = "guloInvit", Order = 2 },
new ExcelFormatTable() { Title = "Agency ID", PropertyName = "guag", Order = 6 },
new ExcelFormatTable() { Title = "Agency", PropertyName = "agN", Order = 7},
new ExcelFormatTable() { Title = "Country ID", PropertyName = "guco", Order = 8 },
new ExcelFormatTable() { Title = "Country", PropertyName = "coN", Order = 9 },
new ExcelFormatTable() { Title = "Pax", PropertyName = "gupax", IsVisible = false },
new ExcelFormatTable() { Title = "Check-In Date", PropertyName = "guCheckInD", Format = EnumFormatTypeExcel.Date, Order = 10 },
new ExcelFormatTable() { Title = "Deposit", PropertyName = "guDeposit", Format = EnumFormatTypeExcel.Currency, Order = 13 },
new ExcelFormatTable() { Title = "Book Date", PropertyName = "guBookD", Format = EnumFormatTypeExcel.Date, Order = 11 },
new ExcelFormatTable() { Title = "Book Cancel", PropertyName = "guBookCanc", Order = 12 }
      };
    }
...
new ExcelFormatTable() { Title = "Proc Vol", PropertyName = "ProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 14, Function = DataFieldFunctions.Sum },
new ExcelFormatTable() { Title = "OOP Vol", PropertyName = "OOPAmount", Format = EnumFormatTypeExcel.Currency, Order = 15, Function = DataFieldFunctions.Sum },
new ExcelFormatTable() { Title = "Canc Vol", PropertyName = "CancAmount", Format = EnumFormatTypeExcel.Currency, Order = 16, Function = DataFieldFunctions.Sum  },
new ExcelFormatTable() { Title = "Pend Vol", PropertyName = "PendAmount", Format = EnumFormatTypeExcel.Currency, Order = 18, Function = DataFieldFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Total Proc", PropertyName = "TotalProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 17, Function = DataFieldFunctions.Sum  }
      };
    }
...
new ExcelFormatTable() { Title = "Amount", PropertyName = "SalesAmount", Format = EnumFormatTypeExcel.Currency, Order = 9, Function = DataFieldFunctions.Sum },
...
new ExcelFormatTable() { Title = "Eff", PropertyName = "Efficiency", Format = EnumFormatTypeExcel.Currency, Order = 10, IsCalculated = true, Formula="IF([Shows]=0,0,[SalesAmount]/[Shows])" },
new ExcelFormatTable() { Title = "Avg Sale", PropertyName = "AverageSale", Format = EnumFormatTypeExcel.Currency, Order = 12, IsCalculated = true, Formula="IF([Sales]=0,0,[SalesAmount]/[Sales])" }
      };
    }
...
new ExcelFormatTable() { Title = "Amount", PropertyName = "SalesAmount", Format = EnumFormatTypeExcel.Currency, Order = 9, SubTotalFunctions = eSubTotalFunctions.Sum },
new ExcelFormatTable() { Title = "Ci %", PropertyName = "ClosingFactor", Format = EnumFormatTypeExcel.Percent, Order = 11, IsCalculated = true, Formula="IF([Shows]=0,0,[Sales]/[Shows])" },
new ExcelFormatTable() { Title = "Eff", PropertyName = "Efficiency", Format = EnumFormatTypeExcel.Currency, Order = 10, IsCalculated = true, Formula="IF([Shows]=0,0,[SalesAmount]/[Shows])" },
new ExcelFormatTable() { Title = "Avg Sale", PropertyName = "AverageSale", Format = EnumFormatTypeExcel.Currency, Order = 12, IsCalculated = true, Formula="IF([Sales]=0,0,[SalesAmount]/[Sales])" }
      };
...
new ExcelFormatTable() { Title = "Amount", PropertyName = "SalesAmount", Format = EnumFormatTypeExcel.Currency, Order = 9, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum },
new ExcelFormatTable() { Title = "Ci %", PropertyName = "ClosingFactor", Format = EnumFormatTypeExcel.Percent, Order = 11, IsCalculated = true, Formula="IF([Shows]=0,0,[Sales]/[Shows])" },
new ExcelFormatTable() { Title = "Eff", PropertyName = "Efficiency", Format = EnumFormatTypeExcel.Currency, Order = 10, IsCalculated = true, Formula="IF([Shows]=0,0,[SalesAmount]/[Shows])" },
new ExcelFormatTable() { Title = "Avg Sale", PropertyName = "AverageSale", Format = EnumFormatTypeExcel.Currency, Order = 12, IsCalculated = true, Formula="IF([Sales]=0,0,[SalesAmount]/[Sales])" }
      };
...
new ExcelFormatTable() { Title = "Processable", PropertyName = "ProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 5, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "OOP", PropertyName = "OOPAmount", Format = EnumFormatTypeExcel.Currency, Order = 7, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "Cancelled", PropertyName = "CancelAmount", Format = EnumFormatTypeExcel.Currency, Order = 9, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "Subtotal", PropertyName = "TotalProc", Format = EnumFormatTypeExcel.Currency, Order = 11, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "Total", PropertyName = "TotalProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 13, SubTotalFunctions = eSubTotalFunctions.Sum },
new ExcelFormatTable() { Title = "Eff", PropertyName = "Efficiency", Format = EnumFormatTypeExcel.Currency, Order = 14, IsCalculated = true, Formula = "IF([Shows]=0, 0, [TotalProcAmount]/[Shows])" },
...
new ExcelFormatTable() { Title = "AvgSales", PropertyName = "AvgSales", Format = EnumFormatTypeExcel.Currency, Order = 16, IsCalculated = true, Formula = "IF([TotalProcSales]=0, 0, [TotalProcAmount]/[TotalProcSales])" },
...
new ExcelFormatTable() { Title = "Pending", PropertyName = "PendAmount", Format = EnumFormatTypeExcel.Currency, Order = 18, SubTotalFunctions = eSubTotalFunctions.Sum }
      };
    }
...
new ExcelFormatTable() { Title = "Liner Name", PropertyName = "saLinerN", Order = 2 },
...
new ExcelFormatTable() { Title = "Processable", PropertyName = "ProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 7, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "OOP", PropertyName = "OOPAmount", Format = EnumFormatTypeExcel.Currency, Order = 9, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Cancelled", PropertyName = "CancAmount", Format = EnumFormatTypeExcel.Currency, Order = 11, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Total", PropertyName = "TotalProcAmount", Format = EnumFormatTypeExcel.Currency, Order = 15, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "Proc Ln", PropertyName = "ProcAmountLn", Format = EnumFormatTypeExcel.Currency, Order = 17, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Proc FM", PropertyName = "ProcAmountFM", Format = EnumFormatTypeExcel.Currency, Order = 19, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Proc FB", PropertyName = "ProcAmountFB", Format = EnumFormatTypeExcel.Currency, Order = 21, SubTotalFunctions = eSubTotalFunctions.Sum  },
...
new ExcelFormatTable() { Title = "Pending", PropertyName = "PendAmount", Format = EnumFormatTypeExcel.Currency, Order = 26, SubTotalFunctions = eSubTotalFunctions.Sum  },
new ExcelFormatTable() { Title = "Eff", PropertyName = "Efficiency", Format = EnumFormatTypeExcel.Currency, Order = 22, IsCalculated = true, Formula = "IF([Shows]=0, 0, [TotalProcAmount]/[Shows])" },
...
new ExcelFormatTable() { Title = "AvgSales", PropertyName = "AvgSales", Format = EnumFormatTypeExcel.Currency, Order = 24, IsCalculated = true, Formula = "IF([TotalProcSales]=0, 0, [TotalProcAmount]/[TotalProcSales])" },
...
new ExcelFormatTable() { Title = "Taxi", PropertyName = "guTaxiIn", Format = EnumFormatTypeExcel.Currency, Order = 10, SubTotalFunctions = eSubTotalFunctions.Sum },
...
new ExcelFormatTable() { Title = "Taxi", PropertyName = "grTaxiOut", Format = EnumFormatTypeExcel.Currency, Order = 9, Function = DataFieldFunctions.Sum },
new ExcelFormatTable() { Title = "Taxi Diff", PropertyName = "grTaxiOutDiff", Format = EnumFormatTypeExcel.Currency, Order = 10, Function = DataFieldFunctions.Sum },
new ExcelFormatTable() { Title = "Chb PP", PropertyName = "grNum", Order = 2 },
...
new ExcelFormatTable() { Title = "Total", PropertyName = "Total", Format = EnumFormatTypeExcel.Currency, Order = 9},
new ExcelFormatTable() { Title = "PR ID", PropertyName = "peID", Order = 10 },
new ExcelFormatTable() { Title = "PR Name", PropertyName = "peN", Order = 11 },
new ExcelFormatTable() { Title = "Amount", PropertyName = "bdAmount", Format = EnumFormatTypeExcel.Currency, Order = 12 },
...
new ExcelFormatTable() { Title = "Proc Vol", PropertyName = "ProcAmount", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 7 },
...
new ExcelFormatTable() { Title = "OOP Amount", PropertyName = "OOPAmount", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 9 },
...
new ExcelFormatTable() { Title = "Cancel Amount", PropertyName = "CancelAmount", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 11 },
...
new ExcelFormatTable() { Title = "Subtotal", PropertyName = "Subtotal", Format = EnumFormatTypeExcel.Currency, IsCalculated = true, Formula = "[ProcAmount]+[OOPAmount]", Order = 13 },
...
new ExcelFormatTable() { Title = "Total Amount", PropertyName = "TotalProcAmount", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 15 },
new ExcelFormatTable() { Title = "Efficiency", PropertyName = "Eff", Format = EnumFormatTypeExcel.Currency, IsCalculated = true, Formula = "IF([Shows]=0,0,[TotalProcAmount]/[Shows])", Order = 16 },
...
new ExcelFormatTable() { Title = "Avg Sale", PropertyName = "AvgSale", Format =  EnumFormatTypeExcel.Currency, IsCalculated = true, Formula = "IF([TotalProc]=0,0,[TotalProcAmount]/[TotalProc])", Order = 18 },
...
new ExcelFormatTable() { Title = "Pending Amount", PropertyName = "PendingAmount", Format = EnumFormatTypeExcel.Currency, Function = DataFieldFunctions.Sum, SubTotalFunctions = eSubTotalFunctions.Sum, Order = 20 }
      };
    }
