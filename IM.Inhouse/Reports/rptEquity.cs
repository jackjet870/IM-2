...
namespace IM.Inhouse.Reports {
    ...
    public class rptEquity : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IM.Inhouse.Reports.rptEquity.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptEquity : Component, ICachedReport {
        
        public CachedrptEquity() {
        }
